            ...
            <div class="col-md-12">
              ...
              <div class="form1">
                <form method="POST">
                    ...
                    <label for="" id="name_label" >Your First Name</label>
                    <label for="" id="mail_label">Your Last Name</label>
                    <br>
                    <input type="text" placeholder="First Name" id="name_input" name="firstName">
                    <input type="text" placeholder="Last Name" id="email_input" name="lastName"> <br>
                    ...
                    <button id="send_btn">Signup</button>
                </form>
              </div>
              </div>
            </div>
